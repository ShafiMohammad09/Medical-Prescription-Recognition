...
def write_image_paths(folder_path, output_file):
  """
  ...
  image_paths = [os.path.join(folder_path, f) for f in os.listdir(folder_path)
                 if os.path.isfile(os.path.join(folder_path, f)) and f.endswith((".jpg", ".jpeg", ".png"))]

  # Write each image path to the output file
...
def all_task():
                                ...
                                folder_path = "runs/detect/exp/crops/medicine"
                                output_file = "img_names_sequence.txt"

                                write_image_paths(folder_path,output_file)
                                    ...
                                    if args.mode in ['train', 'validate']:
                                        ...
                                        for xyz in grades:
                                               ...
                                               try:
                                                      ...
                                                      resullt_word_pred=helpercode(xyz)
